  ...
  calculators: [
    {
      ...
      description: 'Get details for any Indian PIN',
      href: '/calculators/api/pin-lookup',
      category: 'api',
      keywords: ['postal', 'pincode', 'india', 'address'],
    },
    {
      title: 'Area to PIN Code Finder',
      description: 'Find Indian PIN codes by area, locality or city',
      href: '/calculators/api/area-to-pin',
      category: 'api',
      keywords: [
        'area to pincode',
        'pincode by area',
    ...
    },
    {
      ...
      href: '/calculators/api/ifsc-lookup',
      category: 'api',
      keywords: ['bank', 'branch', 'neft', 'rtgs'],
    }
