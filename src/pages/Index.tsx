...
const categories = [
  ...
  },
  {
    ...
    calculators: [
      ...
      { title: 'Area to PIN Code Finder', description: 'Find Indian PIN codes by area, locality or city', icon: <MapPin className="w-5 h-5" />, href: '/calculators/api/area-to-pin' },
    ],
  },
  {
    id: 'misc',
